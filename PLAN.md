...
2. ✅ **ĐÃ CHỐT (2026-08-05): Beachtro Tower — Blanca City** (Sun Property / Sun Group, căn hộ sổ hồng lâu dài, P.10 & P.11 TP Vũng Tàu). Đã thêm `blanca city` + 4 alias vào `keywords/projects.tsv` (246 dự án, +110 kw `brand-blanca-city`), thêm CĐT `sun property` (+8 kw). Bộ launch = 220 kw (lệnh lọc trong `keywords/adgroup-map.md`). LP thật đã có: `https://smartrealtors.vn/beachtro-tower-blanca-city/` — audit đầy đủ ở `landing-page/beachtro-tower-audit.md`. **Đã chốt từ LP**: 1.785 căn (E6 506 / E7 379 / E8 363 / E9 537), 72% quỹ hàng bàn giao thô + DyHome, bàn giao dự kiến 8/2028, phân phối bởi SmartRealtors & Partners. **Không thêm negative sibling** (SmartRealtors bán nhiều phân khu Blanca City). **Còn chờ**: bảng giá + chính sách chính thức từ CĐT — LP tự khai chưa công bố, nên hard gate "khoảng giá" của `landing-page/README.md` đang rớt và cần quyết định kinh doanh, không phải sửa kỹ thuật.
